...
@RestController
public class ListUntouchedCategoriesController {
	private CategoryFacade categoryFacade;
	private CategoryTransformer categoryTransformer;

	@Autowired
	public ListUntouchedCategoriesController(CategoryFacade categoryFacade,
	...
	@RequestMapping("${listUntouchedCategories}")
	public List<CategoryView> categoryList() {
		return transformCategories(categoryFacade.listUntouchedCategories());
	}
